<?php
   ...
   {
      $t->setVariable("session_button","<a href='searchScreen.php?session=start'>Begin session</a>");
   }
   else
   {
      $t->setVariable("session_button","<a href='searchScreen.php?session=end'>End session</a>");
   }
   try
   {
